...
#define INDI_BRIGHT_N 23     // яркость ночная (1 - 24)

#define DOT_BRIGHT 50       // яркость точки дневная (1 - 255)
#define DOT_BRIGHT_N 20     // яркость точки ночная (1 - 255)

#define BACKL_BRIGHT 150    // макс. яркость подсветки ламп дневная (0 - 255)
...
// распиновка ламп
#if (BOARD_TYPE == 0)
const byte digitMask[] = {7, 3, 6, 2, 1, 9, 8, 0, 5, 4};   // маска дешифратора платы in12_turned (цифры нормальные)
